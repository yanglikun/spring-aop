...
/**
 * 从spring 4.0.0直接copy未改动
 * Created by yanglikun on 2017/5/24.
 */
class CustomCglibAopProxy implements AopProxy, Serializable {
     ...
     */
    public CustomCglibAopProxy(AdvisedSupport config) throws AopConfigException {
    ...
    private static class ProxyCallbackFilter implements CallbackFilter {
        ...
        public ProxyCallbackFilter(AdvisedSupport advised, Map<String, Integer> fixedInterceptorMap, int
        ...
        private boolean equalsPointcuts(Advisor a, Advisor b) {
            ...
            return (!(a instanceof PointcutAdvisor) ||
                    (b instanceof PointcutAdvisor &&
                            ObjectUtils.nullSafeEquals(((PointcutAdvisor) a).getPointcut(), ((PointcutAdvisor) b)
                                    .getPointcut())));
        }
